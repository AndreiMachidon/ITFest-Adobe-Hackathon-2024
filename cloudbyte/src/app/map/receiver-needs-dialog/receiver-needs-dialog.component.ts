...
export class ReceiverNeedsDialogComponent {
  ...
  onDonate(element: any) {
    ...
    .then((completion) => {
      ...
      const accountSid = 'ACab2a5dc2a42e65bb8e736eb46203f12f';
      const authToken = '5df303475ad3957ad0658063499837d1';
      const yourNumber = '+40725094632'; 
      const availableNumber = '+12294412125'; 
